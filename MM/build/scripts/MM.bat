...
set CLASSPATH=%APP_HOME%\lib\MM.jar;%APP_HOME%\lib\guava-27.0.1-jre.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-2.5.2.jar;%APP_HOME%\lib\error_prone_annotations-2.2.0.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.17.jar

@rem Execute MM
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MM_OPTS%  -classpath "%CLASSPATH%" it.unicam.cs.pa.mastermind2019.ConsoleGame %CMD_LINE_ARGS%
