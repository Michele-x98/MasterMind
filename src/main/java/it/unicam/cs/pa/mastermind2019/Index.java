...
/**
 * <b>Responsabilità:</b> Iniziare il programma. Abbiamo creato una classe
 * isolata per il main per risolvere conflitti legati ai Log del programma.
 * 
			...
			do
			{
				...
				switch (view.sceltaMenu())
				{
					case 1:
					{
						...
						ConsoleGame direttore = new ConsoleGame(player1.getPlayer(view.typePlayerSelection("CodeMaker"), view), player2.getPlayer(view.typePlayerSelection("CodeBreaker"), view), view, terreno);
